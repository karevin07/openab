...
fn queue_clear_confirmation_card(task: &TaskRecord, items: &[PendingMessage]) -> InteractionCard {
...
fn queue_edit_modal(item: &PendingMessage) -> CreateModal {
    CreateModal::new(
...
fn queue_replace_modal(item: &ActiveMessage) -> CreateModal {
    CreateModal::new(
...
impl Handler {
    ...
    async fn handle_queue_edit_modal(
        &self,
        ctx: &Context,
        modal: &serenity::model::application::ModalInteraction,
    ) {
    ...
    async fn handle_queue_replace_modal(
        &self,
        ctx: &Context,
        modal: &serenity::model::application::ModalInteraction,
    ) {
